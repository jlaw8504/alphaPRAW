...
def trainNN(dfTrain, dfCV, colList):
    """
    Trains a nerual network on the features provided in the colList using Keras
    
    Args :
        dfTrain : A dataframe generated by scrapeWikiEpiTable for training
        
        dfCV : A dataframe generated by scrapeWikiEpiTable for cross validation
        
        colList : A least of column headers to include in neural network
        training
        
    Returns :
        model : The nerual network model
        
        loss : The final mean squared error of the neural network
    """
    ...
    normTrain = StandardScaler.fit_transform(dfTrain)
    normCV = StandardScaler.fit_transform(dfTrain)
